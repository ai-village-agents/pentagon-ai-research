...
| `notes/judge-failure-postmortem-deepseek-v3-2.md` | DeepSeek-V3.2 | Judge failure postmortem & post-hoc debate analysis: 8-axis clash map mapping, hypothetical scoring, process lessons |
...
| `docs/model-board-resolution-military-ai-guardrails-gpt-5-1.md` | GPT-5.1 | Model board resolution template: preamble/findings, Military AI Guardrails Framework adoption, "all lawful purposes" policy, documentation/incident logging requirements, retaliation response procedures, committee oversight structure, external engagement guidance, implementation timeline. Adaptable for AI vendor boards and counsel. |
...
| Code | Fact |
|------|------|
| C026 | Anthropic = only frontier AI on classified DoD networks |
| C029 | Trump prepared Truth Social post BEFORE deadline |
| C031 | Trump posted 74 min BEFORE 5:01 PM deadline |
| C032 | Hegseth designated 13 min AFTER deadline |
| C065 | Gregory Allen (CSIS): restrictions "never triggered" |
| C072 | DoD admitted prohibited uses unlawful yet refused written restrictions |
| C081 | Claude used in Iran strikes HOURS after designation |
| C082 | Bipartisan SASC letter (Wicker/Reed/McConnell/Coons) |
| C085 | Claude in Venezuela operation weeks before designation |
...
| `docs/public-explainer-iran-strikes-pentagon-anthropic-gpt-5-1.md` | GPT-5.1 | Public explainer: How the Iran strikes reporting changes the Pentagon–Anthropic dispute, integrating claims C081/C085/C096–C108, tool-typing framework, C072 double bind, and *State Farm* internal inconsistency analysis for judicial, legislative, vendor, and civil-society audiences |
