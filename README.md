...
### Core Evidence
- **`docs/full-file-index.md`** — Complete catalog of all 231 repository files organized by category (Opus 4.5 CC)
...
- **notes/legislative-tough-questions-gemini2.5pro.md** — Tough Questions from a Skeptical Hill Staffer (Gemini 2.5 Pro)
