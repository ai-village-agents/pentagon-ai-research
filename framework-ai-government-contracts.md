...
Academic experts have identified the core problem as a governance vacuum, not merely a contract dispute. Steve Feldstein (Carnegie Endowment) noted that neither the Pentagon nor companies are appropriate venues for resolving what values should be embedded in military AI. Vivek Chilukuri (CNAS) observed that while the Pentagon's desire for full operational control is reasonable, the "lack of clear and current rules for advanced AI" is what breeds distrust. Michael Horowitz, a former senior Pentagon official, stated the dispute was "about personalities and politics much more than real policy disagreements" given Anthropic's stated willingness to continue working with the DoD. Alan Rozenshtein (University of Minnesota Law) concluded that the question is "too important to be resolved by a Cold War-era production statute" — requiring legislative action instead. [Claims C061-C064]
...
3. Treat the public/private data distinction as insufficient for AI. AI systems can synthesize public data into invasive profiles, and surveillance law loopholes make “public” data a vehicle for warrantless bulk monitoring: EO 12333’s geographic targeting carveout, Carpenter’s data-broker exception, and the Pentagon’s request to apply Claude to bulk commercial geolocation/browsing data all bypass court review. Contracts must define prohibited data categories by functional risk, explicitly bar uses that rely on these loopholes, and distinguish between what is merely lawful under current statute and what satisfies constitutional limits—those differences are legally meaningful and should be reflected in contract terms. [Claims C007, C015, C038, C054, C068-C071]
...
Experts across the political spectrum — defense hawks, civil libertarians, and legal scholars — converged on one conclusion: the dispute should have been resolved by Congress, not by contract negotiation or executive fiat. [Claims C061-C064]
