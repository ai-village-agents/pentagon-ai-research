# Judge Preparation - DeepSeek-V3.2

## Debate Details
- **Day:** 336 (March 3, 2026)
- **Time:** 10:30 AM PT (17:30 UTC)
...
## Key Claim Clusters for Quick Reference

### I. Core Evidence (High Impact)
- **C072:** Pentagon spokesman admitted prohibited uses would be unlawful; refused to put in writing.
- **C065:** Restrictions "never triggered" during actual operations.
- **C029, C031:** Trump's 3:47 PM post before 5:01 PM deadline (predetermined timing).
- **C081:** Military used Claude for Iran strike planning hours after designation.
- **C085:** Military used Claude in Venezuela weeks before designation.
- **C088-C091:** Huawei/Section 889 precedent - Congress required explicit legislation for government-wide bans on foreign adversaries.

### II. Statutory Authority
- **C019, C034:** § 3252 text - "sabotage or subvert" risk, "routine administrative and business applications" excluded.
- **C047-C050:** FASCSA vs § 3252 choice - Hegseth chose § 3252 to avoid 30-day notice, opportunity to respond, judicial review.
- **C050:** Government-wide ban extending to Amazon, Google, Microsoft.

### III. Constitutional/Coercion Arguments
- **C086-C087:** NRA v. Vullo precedent (informal pressure to suppress protected activity).
- **C070:** Bulk collection of commercial data on Americans via data broker loophole.
- **C053-C056:** Fourth Amendment Is Not For Sale Act context.

### IV. Operational Context
- **C026:** Anthropic was only frontier AI company on classified systems.
- **C067:** "Legality is the Pentagon's responsibility as the end user, not the AI vendor."
- **C002:** "any lawful use" standard.

### V. Congressional Reaction
- **C082:** Senator Tillis ("sophomoric")
- **C083:** Senator Warner ("bullying") 
- **C084:** Senator Kaine ("clearly unconstitutional")

## Scoring Template (Rubric: 40/25/20/10/5)

### PRO Team
- **Evidence & Factual Accuracy (0-40):** ______
- **Reasoning & Coherence (0-25):** ______
- **Engagement & Clash (0-20):** ______
- **Clarity & Organization (0-10):** ______
- **Fairness & Steelmanning (0-5):** ______
- **TOTAL:** ______/100
...
## Key Clash Points to Evaluate

### 1. Statutory Authority (§ 3252 vs. Huawei/Section 889)
- **CON Argument:** Congress needed explicit legislation (Section 889) for Huawei foreign adversary bans; Pentagon claims similar authority over domestic company without authorization.
- **PRO Counter:** Different statutes, different purposes - § 3252 addresses dependency risk in specific procurements vs. comprehensive telecom infrastructure ban.
- **Judge's Focus:** Which interpretation better fits statutory text, purpose, and precedent?

### 2. C072 Written Commitment Refusal
- **CON Argument:** Pentagon admitted prohibited uses unlawful; refusal to commit in writing reveals intent to preserve option.
- **PRO Counter:** Written commitments would embed vendor's legal taxonomy into military operations; military decides lawful uses, not vendors.
- **Judge's Focus:** Is refusal to commit to existing legal limits evidence of bad faith or legitimate procurement discretion?

### 3. Operational Necessity vs. Pretext
- **CON Evidence:** C065 (never triggered), C081/C085 (continued use post-designation).
...
## Debate Flow Monitoring

### Opening Statements (Target: ~500 words)
- [ ] PRO opening: Check for clear definition of "legitimate" (lawful, procedurally proper, normatively justified).
- [ ] CON opening: Check for clear theory of illegitimacy (ultra vires, predetermined, coercive).

### Cross-Examination (3 rounds)
- **Round 1:** PRO → CON
- **Round 2:** CON → PRO  
- **Round 3:** Pin-down questions from both sides

### Rebuttals (Target: ~600 words)
- [ ] PRO rebuttal: Should engage with CON's top 2 strongest arguments.
- [ ] CON rebuttal: Should engage with PRO's top 2 strongest arguments.

### Closings (Target: ~300 words)
- [ ] PRO closing: Summary of legal framework holding.
- [ ] CON closing: Summary of three fatal concessions.

## Evidence Citation Checklist

During debate, note:
- **Accurate citations:** Claim IDs correctly represent source content.
- **Relevant citations:** Claim IDs directly support argument made.
